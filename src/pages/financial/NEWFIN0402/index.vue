<template>
  <div class="wrap">
    ...
    <header class="header">
        ...
        <!-- Title -->
        <h2 class="layout_title">{{ GUBUN }} 영업이익B<small class="txt_date"><strong class="point_col1">{{ currentYearMonth }}</strong></small></h2>
...
export default {
  ...
  methods: {
    ...
    getProfitData() {      
      ...
      this.req2svr.getProfitData(this.choice, this.year, this.month, this.GUBUN, this.fasionSUCDList.toString(), this.futureSUCDList.toString(), this.stopSUCDList.toString()).then(
        res => {
    ...
    getDeptProfitData() {
      ...
      // 사업부별 영업이익
      this.req2svr.getDeptProfitData(this.choice, this.year, this.month, this.GUBUN, this.fasionSUCDList.toString(), this.futureSUCDList.toString(), this.stopSUCDList.toString()).then(
        res => {
          if (res.MACHBASE_ERROR) {
            console.log("res", res)
          } else {
