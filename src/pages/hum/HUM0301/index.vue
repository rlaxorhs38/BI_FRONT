                    ...
                    <div class="row">
                        <div class="col_md_3 info_view">
                            <div class="box" style="top: -5px">
                                <div class="inner">
                                    <div class="num_box2 bg_point_col9">
                                      <small>타사</small>
                                      <hr>
                                    ...
                                    <div class="box_info">
                                        <p class="txt ">{{leftInfoData.NAME}} SD
                                            <span class="chip chip_m point_col9 point_box9"><span class="chip_text">{{leftInfoData.JAEJIGNM}}</span></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="info_list list_sty01">
                                <ul class="list">
                                    <li>
                                        ...
                                        <span class="cont point_col16">{{leftInfoData.BRNM}}</span>
                                    </li>
                                    <li>
                        ...
                        <div class="col_md_9">
                            <div class="inner">
                                ...
                                <div class="hum_list_box mb20">
                                    ...
                                    <div class="list_card">
                                        <ul class="list">
                                            <li class="list_card_item noline">
                                                <span class="list_card_item_main">
                                                    <!-- LEFT -->
                                                    <em class="em_year">{{ currentYear-1 }}</em><br>
                                                    <small>매출누계</small>
                                                </span>
                                                <span class="fr">
                                                    <em class="em_total vb">{{ Math.round(bagicInfoTopData.CUYEAR_AMT/100000000) | currency }}</em>
                                                    <small class="sm_unit">억</small>
                                                </span>
...
export default {
  ...
  methods: {
    ...
    getLeftInfoData(){
      ...
      this.req2svr.getLeftInfoData2(this.hrid, this.sno, this.currentYear).then(
        res => {
          if (res.MACHBASE_ERROR) {
            console.log("res", res);
          } else {
    ...
    getBagicInfoTopData(){
      ...
      this.req2svr.getBagicInfoTopData2(this.sno).then(
        res => {
          if (res.MACHBASE_ERROR) {
            console.log("res", res);
          } else {
    ...
    getSpecialNote(){
      ...
      this.req2svr.getSpecialNote2(this.sno).then(
        res => {
          this.SpecialNote = {}
          if (res.MACHBASE_ERROR) {
            console.log("res", res);
    ...
    getSalesManagerData(){
      ...
      this.req2svr.getSalesManagerData2(this.sno).then(
        res => {
          if (res.MACHBASE_ERROR) {
            console.log("res", res);
          } else {
